...
import { Eye, EyeOff, Loader2, Lock, Mail } from 'lucide-react'; // Changed User to Mail icon
...
export default function Login() {
  ...
  const handleGoogleLogin = async () => {
    setError('');
    // Let the auth context handle the loading state for redirects
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-background via-background to-muted/30">
      ...
      <footer className="p-6 text-center">
        <p className="text-xs text-muted-foreground">Secure billing solution for Indian businesses</p>
      </footer>
    </div>
  );
}
